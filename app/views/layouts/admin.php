...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="<?=PATH;?>" class="logo" target="_blank">
            ...
            <span class="logo-lg"><b>Main</b>User</span>
        </a>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="dist/img/sonya1.jpg" class="user-image" alt="User Image">
                            <span class="hidden-xs"><?=$_SESSION['user']['name'];?></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="dist/img/sonya1.jpg" class="img-circle" alt="User Image">

                                <p>
                                    <?=$_SESSION['user']['name'];?> - Student
                                    <small>FB-82</small>
                                </p>
                            </li>
                            <!-- Menu Footer-->
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="<?= ADMIN ?>/"><i class="fa fa-home"></i> <span>Домой</span></a></li>
                ...
                <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?= ADMIN ?>/category">Актуальные</a></li>
                        <li><a href="<?= ADMIN ?>/category/add">Добавить</a></li>
                    </ul>
                </li>
